...
const userSchema = new mongoose.Schema({
  ...
  avatarUrl: String,
  videos: [{ type: mongoose.Schema.Types.ObjectId, required: true, ref: "Video" }], //ObjectId 타입은 mongoose에서 제공하는 16진수 24자리다.  ref:"Video"는 이 videos의 요소는 Video Model을 참조한다는 뜻
